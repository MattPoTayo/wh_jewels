		...
		<div>
			...
			<div class="table-wrapper">
					...
					<?php
						...
						$result = mysqli_query($mysqli, "SELECT ID, `Name`, `Address`, `Phone`, `Birthdate`, `Username` FROM `entity` WHERE `Mark` = 1 AND Type = 4");
						...
						{	
							...
							//Actions
							echo '<td><a href="clients_history.php?id='.$row[0].'&action=view"><i class="fa fa-file" aria-hidden="true"></i> View</a></td>';

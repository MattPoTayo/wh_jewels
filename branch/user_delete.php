<?php
	...
	if(isset($_GET['action']) AND $_GET['action'] == "delete" AND  isset($_GET['employee']))
	{
		...
		$_SESSION['success'] = "Successfully deleted user! If this is a mistake, please contact Tangent.";
	...
	else if(isset($_GET['action']) AND $_GET['action'] == "reset" AND  isset($_GET['employee']))
	{
		...
		$_SESSION['success'] = "Successfully changed user password to whjewels! If this is a mistake, please contact Tangent.";
		header("location:users.php");
	}
	else
	{

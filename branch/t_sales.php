...
<html>
	...
	<body>
		<?php 
			...
			{
				$client = $mysqli->real_escape_string($_POST['destination']);
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div style="margin-right:-10px">
						<div class="form_class_view">
							<div class="form_title_view">Trust Receipt Agreement Details</div>
				...
				<div class="selecttable" style="width:98%;margin-left:1%">
					...
					<?php
						...
						{	
							...
							//Delete
							echo '<td><a href="inventory_edit.php?inventory='.$row[0].'&sid='.$sid.'"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>&nbsp|&nbsp<a href="t_sales.php?delete='.$row[0].'"><i class="fa fa-times" aria-hidden="true"></i> Delete</a></td>';
				...
				<div class="selecttable" style="width:100%;margin-left:1%">
					...
					<?php
						...
						echo '<th style="width:10%;text-align:center">Number</th>';
					...
					<form method=post action="<?php echo $_SERVER['PHP_SELF'];?>" >
						...
						<td><input type="text" name="cnum" placeholder="Check No." class="form-control"></td>
						...
						<td><button name="add" type="submit" class="view_button">Pay</button></td>
					</form>
					...
					<?php
						...
						{	
							...
							//Delete
							echo '<td><a href="t_sales.php?pdelete='.$row[0].'"><i class="fa fa-times" aria-hidden="true"></i> Delete</a></td>';
				...
				<div class="selecttable" style="width:98%;margin-left:1%">
			        	<table class="table" style="font-size:12px;width:100%">
			        		<tr style="text-align:center;">
			        			...
			        			<td style="width:8%"><a class='btn view_button' href='t_sales.php?save=true' role='button'>Save</a></td>
			        			<td style="width:8%"><a class='btn view_button' href='t_sales.php?cancel=true' role='button'>Cancel</a></td>
			        			<?php if($reference != "") { ?> <td style="width:8%"><a class='btn view_button' href='t_sales.php?finalize=true' role='button'>Finalize</a></td><?php } ?>
			        		</tr>
			        	</table>
			        </div>
			</div>
